      ...
      <section className="hidden md:block px-4 sm:px-6 md:px-12 py-16 sm:py-24 md:py-32 bg-[#f0f0f0]" aria-labelledby="metrics-title">
        <div className="max-w-screen-2xl mx-auto">
          <div className="mb-16 md:mb-24 relative">
            <h2
              id="metrics-title"
              className="font-bold tracking-tighter leading-[0.85] mb-6 sm:mb-10 flex items-start"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-0 border-2 border-[#1a1c1c]">
            ...
            <div className="bg-[#f0f0f0] border-r-0 lg:border-r-2 border-b-2 lg:border-b-0 border-[#1a1c1c] p-6 sm:p-10 md:p-16 xl:p-20 flex flex-col justify-center">
              <span className="text-xs font-bold font-mono tracking-widest uppercase opacity-50 mb-6 sm:mb-8 border border-[#1a1c1c] w-fit px-3 py-1">Urban Farming Sector</span>
              <h3
                className="font-bold tracking-tighter leading-[0.9] mb-6 sm:mb-8"
                style={{ fontSize: 'clamp(1.8rem, 4vw, 4.5rem)' }}
              >
                Project Alpha:<br/>300% Yield<br/>Increase
              </h3>
              <p className="text-base sm:text-lg opacity-80 mb-12 sm:mb-16 max-w-md font-medium leading-relaxed">
              ...
              <button onClick={scrollToContact} className="text-[#e2241f] font-bold tracking-widest text-sm hover:opacity-70 transition-opacity w-fit flex items-center gap-2 cursor-pointer min-h-[44px]">
                [ READ CASE STUDY ] <ArrowUpRight className="w-4 h-4" aria-hidden="true" />
              </button>
            </div>
            {/* Project Alpha - Right Black */}
            <div className="bg-[#1a1c1c] text-white p-6 sm:p-10 md:p-16 xl:p-20 flex flex-col justify-center border-b-2 lg:border-b-0 border-[#1a1c1c] relative overflow-hidden">
              <div
                className="font-bold tracking-tighter leading-none mb-2 relative z-10"
              ...
              <BarChart
                values={[30, 50, 80, 100]}
                targetValue={counts.yield}
                className="flex items-end gap-3 mt-16 sm:mt-24 h-36 sm:h-48 w-full max-w-sm relative z-10"
                color="#f0f0f0"
                accentColor="#e2241f"
              />
            </div>
            ...
            <div className="bg-[#1a1c1c] text-white p-6 sm:p-10 md:p-16 xl:p-20 flex flex-col justify-center border-r-0 lg:border-r-2 border-t-0 lg:border-t-2 border-[#1a1c1c]">
              {/* Animated Ranking Visual */}
              <BarChart
                values={[30, 70, 50, 100]}
                targetValue={counts.efficiency}
                className="flex items-end gap-3 mb-16 sm:mb-24 h-20 sm:h-24 w-full max-w-[200px]"
                color="#e2241f"
                accentColor="#fff"
              />

              <div
                className="font-bold text-[#e2241f] tracking-tighter leading-none mb-4"
                style={{ fontSize: 'clamp(3.5rem, 10vw, 8rem)' }}
              >{counts.efficiency}%</div>
              <div className="text-sm font-mono tracking-widest uppercase opacity-60">Resource Efficiency</div>
            </div>
            {/* Project Beta - Right White */}
            <div className="bg-[#f0f0f0] p-6 sm:p-10 md:p-16 xl:p-20 flex flex-col justify-center border-t-0 lg:border-t-2 border-[#1a1c1c]">
              <span className="text-xs font-bold font-mono tracking-widest uppercase opacity-50 mb-6 sm:mb-8 border border-[#1a1c1c] w-fit px-3 py-1">Commercial Agritech</span>
              <h3
                className="font-bold tracking-tighter leading-[0.9] mb-6 sm:mb-8"
                style={{ fontSize: 'clamp(1.8rem, 4vw, 4.5rem)' }}
              >
                Project Beta:<br/>Resource<br/>Efficiency
              </h3>
              <p className="text-base sm:text-lg opacity-80 mb-12 sm:mb-16 max-w-md font-medium leading-relaxed">
