  ...
  return (
    <section id="projects" className="px-4 sm:px-6 md:px-12 py-16 sm:py-24 md:py-32 bg-[#f0f0f0] relative overflow-hidden" aria-labelledby="projects-title">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        ...
        <div className="border-2 sm:border-4 border-[#1a1c1c] bg-[#1a1c1c] text-white relative flex flex-col group shadow-[8px_8px_0px_0px_#e2241f] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_#e2241f] transition-all duration-300">
          {/* Grid overlay */}
          <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: 'linear-gradient(#ffffff 1px, transparent 1px), linear-gradient(90deg, #ffffff 1px, transparent 1px)', backgroundSize: '40px 40px' }} aria-hidden="true"></div>
          
          <div className="relative z-10 flex flex-col h-full p-6 sm:p-8 md:p-12">
            {/* Header/Logo */}
            <div className="mb-8">
              <span className="text-[2rem] sm:text-[3rem] font-extrabold tracking-[-0.06em] leading-none text-white">Cedar Initiative</span>
            </div>
            ...
            {/* Description */}
            <p className="text-sm sm:text-base opacity-80 leading-relaxed font-medium mb-12 flex-grow max-w-md">
            ...
            <a
              ...
              className="bg-[#e2241f] text-white px-6 sm:px-8 py-3 sm:py-4 font-bold tracking-widest text-xs sm:text-sm hover:bg-white hover:text-[#e2241f] transition-colors uppercase flex items-center justify-between gap-3 sm:gap-4 cursor-pointer w-full mt-auto"
            >
